...
const PartsPage: React.FC<PartsPageProps> = ({ sites }) => (
  <div className="space-y-4">
    <PageHeading
      ...
      description="Штучные материалы, выданные механиками. Выберите строки и спишите их в 1С; правка, отмена и возврат из 1С — в меню строки. Выгрузка учитывает текущий фильтр."
    />
